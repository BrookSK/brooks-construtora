...
class Router
{
    ...
    private function handleAdminRoute(array $segments): void
    {
        ...
        $routes = [
            ...
            'settings/upload-avatar' => ['SettingsController', 'uploadAvatar'],
            'settings/remove-avatar' => ['SettingsController', 'removeAvatar'],
            ...
            'orders/mark-in-transport' => ['PurchaseOrderController', 'markInTransport'],
            'orders/unmark-in-transport' => ['PurchaseOrderController', 'unmarkInTransport'],
            'orders/mark-arrived' => ['PurchaseOrderController', 'markArrived'],
            'orders/unmark-arrived' => ['PurchaseOrderController', 'unmarkArrived'],
            ...
            'briefing/polish-text' => ['BriefingController', 'polishText'],
            ...
            'weekly-materials/notify-manager' => ['WeeklyMaterialController', 'notifyManager'],
            'weekly-materials/notify-all' => ['WeeklyMaterialController', 'notifyAll'],
    ...
    private function handleSiteRoute(array $segments): void
    {
        ...
        $routes = [
            ...
            'relatorio-lista-semanal/sync-logins' => ['WeeklyReportController', 'syncLogins'],
