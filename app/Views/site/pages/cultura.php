...
<section class="section dark-section" id="manifesto">
    <div class="container">
        ...
        <div class="reveal" style="max-width: 860px; margin: 0 auto; border-radius: 16px; overflow: hidden; border: 1px solid rgba(212,175,55,0.15); box-shadow: 0 0 80px rgba(212,175,55,0.05);">
