<?php
$pageTitle = 'Projetos';
$pageDescription = 'Conheça os projetos de reforma e construção de alto padrão da Brooks Construtora em São Paulo. Residenciais, corporativos e muito mais.';
    ...
    <div class="container">
        <div class="grid grid--2 reveal" style="gap: var(--space-xl);">
            ...
            <a href="/projeto/projeto-rocha-andrade" class="project-card">
                ...
                <div class="project-card__overlay">
                    <div class="project-card__content">
                        ...
                        <p class="project-card__subtitle">Reforma completa de apartamento · 300m²</p>
            ...
            <a href="/projeto/projeto-norah-carneiro" class="project-card">
                ...
                <div class="project-card__overlay">
                    <div class="project-card__content">
                        ...
                        <p class="project-card__subtitle">Reforma completa de apartamento · 250m²</p>
                        <span class="project-card__arrow">Ver detalhes <i data-lucide="arrow-right" style="width:14px;height:14px;"></i></span>
                    </div>
                </div>
            </a>
            ...
            <a href="/projeto/reforma-corporativa-cafeteria-do-palacio-dos-bandeirantes" class="project-card">
                <img src="/assets/images/wp/2024/11/palacio-bandeirantes-jpg.webp" alt="Reforma Corporativa - Palácio dos Bandeirantes" class="project-card__image" loading="lazy">
                <div class="project-card__overlay">
                    <div class="project-card__content">
            ...
            <a href="/projeto/reforma-corporativa-de-escritorio-no-itaim-bibi" class="project-card">
                <img src="/assets/images/wp/2024/11/escritorio-itaim-jpeg.webp" alt="Reforma Corporativa - Itaim Bibi" class="project-card__image" loading="lazy">
                <div class="project-card__overlay">
                    <div class="project-card__content">
                        <h3 class="project-card__title">Reforma Corporativa</h3>
            ...
            <a href="/projeto/reforma-completa-de-mansao-no-alphaville" class="project-card">
                <img src="/assets/images/wp/2024/11/mansao-alphaville-jpeg.webp" alt="Mansão Alphaville" class="project-card__image" loading="lazy">
                <div class="project-card__overlay">
                    <div class="project-card__content">
                        <h3 class="project-card__title">Reforma de Mansão</h3>
                        <p class="project-card__subtitle">Reforma completa no Alphaville</p>
                        <span class="project-card__arrow">Ver detalhes <i data-lucide="arrow-right" style="width:14px;height:14px;"></i></span>
                    </div>
                </div>
            </a>
            ...
            <a href="/projeto/projeto-joia-bergamo-2" class="project-card">
                <img src="/assets/images/wp/2024/11/bergamo2-jpg.webp" alt="Projeto Jóia Bergamo 2" class="project-card__image" loading="lazy">
                <div class="project-card__overlay">
                    <div class="project-card__content">
            ...
            <a href="/projeto/projeto-milena-niemeyer-moema" class="project-card">
                <img src="/assets/images/projects/milena-niemeyer/milena-13.jpeg" alt="Projeto Milena Niemeyer | Moema" class="project-card__image" loading="lazy">
                <div class="project-card__overlay">
                    <div class="project-card__content">
...
<section class="section section--gray" style="padding: var(--space-4xl) 0;">
    <div class="container text-center reveal">
        <h2 class="headline-subsection">Quer transformar o seu espaço?</h2>
        <p class="subtitle subtitle--centered" style="margin-bottom: var(--space-xl);">Entre em contato e solicite um orçamento sem compromisso. Atendemos São Paulo e região.</p>
