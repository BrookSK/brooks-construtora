...
$projectsData = [
    'projeto-rocha-andrade' => [
        ...
        'subtitle' => 'Construção completa de apartamento · 300m²',
        'description' => 'Construção completa de apartamento de 300m² com acabamento de alto padrão. Projeto executado com excelência, desde a demolição até os acabamentos finais.',
    ...
    'projeto-norah-carneiro' => [
        ...
        'subtitle' => 'Construção completa de apartamento · 250m²',
        'description' => 'Construção completa de apartamento de 250m² com design sofisticado e acabamentos premium. Cada ambiente pensado para unir funcionalidade e elegância.',
        'location' => 'São Paulo, SP',
        'area' => '250m²',
        'type' => 'Residencial',
    ...
    'projeto-joia-bergamo-2' => [
        ...
        'subtitle' => 'Construção completa de apartamento · 270m²',
        'description' => 'Construção completa de apartamento de 270m² no edifício Jóia Bergamo. Projeto exclusivo com acabamentos de alto padrão.',
        'location' => 'São Paulo, SP',
        'area' => '270m²',
        'type' => 'Residencial',
    ...
    'projeto-joia-bergamo-rsvp' => [
        ...
        'subtitle' => 'Construção completa de apartamento · 270m²',
        'description' => 'Construção completa de apartamento de 270m² no edifício Jóia Bergamo. Execução impecável com atenção a cada detalhe.',
        'location' => 'São Paulo, SP',
        'area' => '270m²',
        'type' => 'Residencial',
    ...
    'construcao-completa-de-mansao-no-alphaville' => [
        'title' => 'Projeto Bárbara Dundes | Alphaville',
        'subtitle' => 'Construção completa de mansão · Alphaville',
        'description' => 'Construção completa de mansão no condomínio Alphaville. Projeto de grande porte executado com toda a estrutura e qualidade Brooks.',
    ...
    'construcao-corporativa-cafeteria-do-palacio-dos-bandeirantes' => [
        'title' => 'Construção Corporativa',
        'subtitle' => 'Cafeteria do Palácio dos Bandeirantes',
        'description' => 'Construção completa da cafeteria do Palácio dos Bandeirantes. Execução em horário noturno e finais de semana, sem interromper o funcionamento do edifício.',
        'location' => 'São Paulo, SP',
        'area' => 'Corporativo',
        'type' => 'Corporativo',
    ...
    'construcao-corporativa-de-escritorio-no-itaim-bibi' => [
        ...
        'description' => 'Construção completa de escritório no Itaim Bibi. Execução noturna e finais de semana, garantindo zero impacto na operação do cliente.',
    ...
    'projeto-milena-niemeyer-moema' => [
        ...
        'subtitle' => 'Construção completa de apartamento · 500m²',
        'description' => 'Construção completa de um apartamento de 500 m². Um projeto clássico, onde cada detalhe carrega história, identidade e alma. Uma arquitetura que atravessa o tempo e traduz a essência de quem vive ali. Brooks Construtora. Engenharia para projetos que deixam legado.',
    ...
    'projeto-katty-kaitazoff-alphaville' => [
        ...
        'subtitle' => 'Construção completa de residência · Alphaville',
        'description' => 'Uma construção completa. Desafiadora. Estruturalmente precisa. A retirada de 18 pilares de sustentação transformou por completo esta residência e abriu espaço para uma nova casa, uma nova história e um novo sonho realizado. Engenharia, técnica e execução para tornar possível aquilo que um dia foi apenas imaginado. Brooks Construtora. Engenharia para projetos que deixam legado.',
        'location' => 'Alphaville, SP',
        'area' => 'Residência',
        'type' => 'Residencial',
