...
<head>
	...
	<!-- Flatsome Icons (CSS-only, sem dependência de font files) -->
	<style>
		...
		.icon-angle-down:before { content: "▼"; font-size: 0.6em; }
		.icon-angle-up:before { content: "▲"; font-size: 0.6em; }
		.icon-menu:before { content: "☰"; font-size: 1.4em; }
		.icon-search:before { content: "🔍"; font-size: 1em; }
		...
		.qlwapp-whatsapp-icon:before { content: ""; }
	</style>
