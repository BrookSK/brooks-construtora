    ...
    <div class="container">
        ...
        <div class="footer-main">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-col__list">
                    <li><a href="/cultura#nucleo">Núcleo</a></li>
...
<div class="chat-widget" id="chat-widget" aria-hidden="true">
    ...
    <div class="chat-widget__body" id="chat-body">
        ...
        <div class="chat-widget__questions" id="chat-questions">
            <button class="chat-widget__question-btn" data-answer="A Brooks Construtora atua há mais de 10 anos no mercado de construção civil de alto padrão em São Paulo. Construções residenciais, corporativas e reformas completas em imóveis acima de 200 metros.">Quais serviços vocês oferecem?</button>
            <button class="chat-widget__question-btn" data-answer="A Brooks atua há mais de 10 anos no mercado. Somos uma das únicas construtoras com setor de tecnologia próprio. Crescemos através da qualidade, da organização, dos processos e, acima de tudo, das pessoas.">Há quanto tempo a Brooks existe?</button>
            <button class="chat-widget__question-btn" data-answer="Atendemos São Paulo e região metropolitana. Nosso escritório fica na Av. Brigadeiro Faria Lima, 1811 - Cj. 910 - Jardim Paulistano - São Paulo/SP.">Qual a área de atuação?</button>
            ...
            <button class="chat-widget__question-btn" data-answer="A Vetriks é nosso sistema integrado de gestão de obras com IA e automação avançada. Criado pela Brooks, forjado em 10 anos de campo, e utilizado por diversas outras construtoras.">O que é a Vetriks?</button>
            <button class="chat-widget__question-btn" data-answer="Sim! Temos o equipamento Matterport na empresa. Criamos gêmeos digitais e tours virtuais 3D de todos os nossos projetos. O cliente acompanha cada etapa da obra de qualquer lugar do mundo.">Vocês fazem tour virtual da obra?</button>
            <button class="chat-widget__question-btn" data-answer="A Brooks Academy é nossa escola profissionalizante dentro dos canteiros de obra. Oferecemos plano de carreira, cursos profissionalizantes e bolsas de até 1 ano de engenharia civil EAD para colaboradores que se destacam.">O que é a Brooks Academy?</button>
            <button class="chat-widget__question-btn" data-answer="Buscamos profissionais comprometidos com excelência, organização e evolução constante. Acesse a página Trabalhe Conosco no nosso site e envie seu currículo.">Como trabalhar na Brooks?</button>
            <button class="chat-widget__question-btn" data-answer="O Força Estrutural é um grupo de empresários da construção civil criado pela Brooks. Nasceu para combater a solidão do empresário, onde concorrentes se tornam parceiros, compartilham conhecimento e crescem juntos.">O que é o Força Estrutural?</button>
        </div>
    </div>
