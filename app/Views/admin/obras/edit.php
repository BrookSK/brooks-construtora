                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="project_type">
                            <option value="construction" <?= ($site['project_type'] ?? 'construction') === 'construction' ? 'selected' : '' ?>>🏗️ Construção</option>
                            <option value="renovation" <?= ($site['project_type'] ?? 'construction') === 'renovation' ? 'selected' : '' ?>>🔧 Reforma</option>
                        </select>
