...
<?php
$roleLabels = ['buyer'=>'Comprador/Entrega','quoter'=>'Cotador','approver'=>'Aprovador','payment'=>'Financeiro','delivery'=>'Comprador/Entrega','epi'=>'EPI','stock'=>'Estoque','all'=>'Completo'];
$roleColors = ['buyer'=>'primary','quoter'=>'warning','approver'=>'info','payment'=>'success','delivery'=>'primary','epi'=>'dark','stock'=>'orange','all'=>'secondary'];
?>
                ...
                <form method="POST" action="/admin/orders/generate-invite">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="role" required>
                            ...
                            <option value="stock">Estoque (pedidos, materiais, transporte)</option>
                        ...
                        <td>
                            <form method="POST" action="/admin/orders/update-pin-user" class="d-inline">
                                ...
                                <select class="form-select form-select-sm d-inline-block" name="role" style="width:auto; font-size:0.7rem;" onchange="this.form.submit()">
                                    ...
                                    <option value="stock" <?= $u['role'] === 'stock' ? 'selected' : '' ?>>Estoque</option>
