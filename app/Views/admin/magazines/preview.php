...
<!-- PÁG INTERNA 05: 2 imagens topo + imagem esquerda com texto direita + continuação 2 colunas -->
<div class="page pg-int">
    <div class="hdr"><div class="logo-sm">BROO<span class="ck">K</span>S<small>CONSTRUTORA</small></div><div class="pn"><?= $displayPageNum ?></div></div>
    ...
    <div style="display:flex;gap:12px;margin-top:10px">
        <div style="flex:1"><?php if($img3): ?><img src="<?= $img3 ?>" style="width:100%;height:220px;object-fit:cover;margin-bottom:8px" alt=""><?php elseif($showImages): ?><div class="img-placeholder" style="width:100%;height:220px;margin-bottom:8px">IMAGEM</div><?php endif; ?><?php foreach(explode("\n",$cols[0]??'') as $p): if(trim($p)): ?><p class="text"><?= htmlspecialchars(trim($p)) ?></p><?php endif; endforeach; ?></div>
