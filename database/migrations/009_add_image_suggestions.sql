...
ALTER TABLE `magazine_pages` ADD COLUMN `image_suggestion` TEXT NULL AFTER `caption`;
ALTER TABLE `magazine_pages` ADD COLUMN `image_suggestion_2` TEXT NULL AFTER `image_suggestion`;
